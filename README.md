...
<img src="images/distancia_euclidiana.png" width="75%">
...
<img src="images/distancia_manhattan.png" width="75%">
...
En la siguiente demostración se sube una foto de Britney Spears para realizar la consulta. Internamente se ejecuta el algoritmo KNN Secuencial con cola de prioridad utilizando la distancia ecludiana. El resultado que se muestra en el frontend son los k elementos más similares que se tienen de la colección total de fotos.
